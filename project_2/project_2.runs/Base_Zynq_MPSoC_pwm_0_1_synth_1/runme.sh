...
HD_PWD='/home/manvar00/Downloads/RELEASE_DVD/vivado_designs/zcu102_src/project_2/project_2.runs/Base_Zynq_MPSoC_pwm_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Zynq_MPSoC_pwm_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Base_Zynq_MPSoC_pwm_0_1.tcl
