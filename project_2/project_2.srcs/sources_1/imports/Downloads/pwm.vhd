...
ENTITY pwm IS
  ...
  PORT(
      ...
      duty_ena      : IN  STD_LOGIC_VECTOR(bits_resolution DOWNTO 0); --duty cycle
...
ARCHITECTURE logic OF pwm IS
  ...
  SIGNAL    ena       :  STD_LOGIC;                                    --latches in new duty cycle
  SIGNAL    duty      : STD_LOGIC_VECTOR(bits_resolution-1 DOWNTO 0); --duty cycle
BEGIN
  PROCESS(clk, reset_n)
  BEGIN
  ena <= duty_ena(bits_resolution);
  duty <= duty_ena(bits_resolution-1 DOWNTO 0);
